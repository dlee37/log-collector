...
public class Constants {
    ...
    public static final int MAX_REQUEST_TIMEOUT_IN_SECONDS = 60;
    public static final String HEALTH_CHECK_STATUS_OK = "ok";
    public static final String HEALTH_CHECK_VERSION = "1.0.0";
}
